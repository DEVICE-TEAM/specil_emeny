...
function Ach:init()
    ...
    self.name = "So Long" -- Display name
    ...
    self.desc = "You achieved an ending." -- Description
    self.hint = "So Long." -- If info hidden is true then this will show up in place of description, used for hints
